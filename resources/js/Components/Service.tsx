...
const Service = () => {
    ...
    return (
        <>
            ...
            <motion.section
                className="w-full md:py-20 py-10 md:px-0 px-4 bg-[#222021]"
            ...
            >
                <div className="max-w-screen-xl mx-auto md:px-20">
                    <div className="w-full  min-h-[300px] justify-center items-center md:flex grid grid-cols-1 gap-x-20 ">
                        <motion.div
                            className="md:w-1/2  flex justify-center items-center h-full relative"
                        ...
                        >
                            <div className="w-full h-full">
                                ...
                                <div className="flex justify-center items-center gap-4 md:mt-5">
                        ...
                        <motion.div
                            className="md:w-1/2 flex justify-center  flex-col mt-10"
                            variants={itemVariants}
                        >
                            <motion.img
                                src="/assets/images/services/salle-de-bain.svg"
                                alt="Service Image"
                                className="md:w-16 w-12 mt-10 md:mt-0"
                                variants={itemVariants}
                            />
                            <motion.div
                                className="flex flex-col gap-y-4 md:mt-20 mt-10"
                                variants={itemVariants}
                            >
            ...
            {/* Section Plomberie */}
            <motion.section
                className="w-full md:py-20 py-10 md:px-0 px-4"
                variants={sectionVariants}
                initial="hidden"
                whileInView="visible"
                viewport={{ once: true, amount: 0.3 }}
            >
                <div className="max-w-screen-xl mx-auto md:px-20">
                    <div className="w-full  min-h-[300px] md:flex grid grid-cols-1 gap-x-20">
                        <motion.div
                            className="md:w-1/2 flex justify-center items-center  overflow-hidden rounded-2xl md:h-[500px]"
                            variants={imageVariants}
                            transition={{ duration: 0.8 }}
                        >
            ...
            {/* Section Chauffage */}
            <motion.section
                className="w-full md:py-20 py-10 px-4 md:px-4  bg-light"
                variants={sectionVariants}
                initial="hidden"
                whileInView="visible"
                viewport={{ once: true, amount: 0.3 }}
            >
                <div className="max-w-screen-xl mx-auto md:px-20">
                    <div className="w-full  min-h-[300px] md:flex grid grid-cols-1 gap-x-20">
                        ...
                        <motion.div
                            className="md:w-1/2 w-full flex justify-center items-center mt-10 md:mt-0  overflow-hidden rounded-2xl md:h-[500px]"
                            variants={imageVariants}
                            transition={{ duration: 0.8 }}
                        >
            ...
            <motion.section
                className="w-full md:py-20 py-10 px-4 md:px-0 bg-[#00ADEF]"
                variants={sectionVariants}
                initial="hidden"
                whileInView="visible"
                viewport={{ once: true, amount: 0.3 }}
                    ...
                    <div className="w-full  min-h-[300px] md:flex grid grid-cols-1  gap-x-20">
                        ...
                        >
                            <motion.img
                                ...
                                alt="Service Image"
                                className="md:w-16 w-12 mb-10 md:mb-0"
                                variants={itemVariants}
                            />
                            <motion.div
                                className="flex flex-col gap-y-4 md:mt-20"
                                variants={itemVariants}
                            >
                            ...
                            <motion.div variants={itemVariants}>
                                <ButtonLink href="/contact" className="bg-[#222021] text-white font-bold flex w-[220px] justify-center items-center py-4 px-5 text-sm rounded-full md:mt-10 transition-all duration-500 hover:bg-[#FF43AF]">Installation climatisation</ButtonLink>
                            </motion.div>
                        </motion.div>
                        <motion.div
                            className="md:w-1/2 mt-10 md:mt-0 flex justify-center items-center relative  overflow-hidden rounded-2xl min-h-[500px]"
                            variants={imageVariants}
                            transition={{ duration: 0.8 }}
                        >
                            <motion.div
                                className="md:w-[350px] md:h-[300px] overflow-hidden absolute -bottom-0 left-0 rounded-2xl z-10"
                                variants={{
                            ...
                            <motion.div
                                className="md:w-[330px] md:h-[270px] overflow-hidden rounded-2xl absolute top-0 right-0"
                                variants={{
                                    hidden: { opacity: 0, x: 50, y: -50 },
                                    visible: {
                                        opacity: 1,
