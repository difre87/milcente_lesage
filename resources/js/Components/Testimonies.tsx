        ...
        <section className="py-20 bg-white">
            <div className="max-w-screen-xl mx-auto w-full">
                <div className="w-full flex justify-between items-center">
                    <h1 className="font-bold text-4xl text-[#222021]">Milcent Lesage, les avis de nos clients<br/> sur notre entreprise près d'Orléans</h1>
                    <div className="flex gap-x-5 items-center">
                        <Link href={""} className="px-10 py-5 transition-all duration-500 bg-[#00ADEF] rounded-full text-white font-bold flex justify-center items-center text-sm gap-x-1 hover:bg-[#222021] group">Rendez-vous <ArrowRight className="w-4 h-4 transition-all duration-150 ease-in-out group-hover:pl-1"/></Link>
